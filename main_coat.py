...
from conf.coat import Config
from utils.search_params import search_params
from utils.dataloader.coat.loadar import DataLoader
...
def main(cfg: Config) -> None:
    ...
    Args:
    - cfg (ExperimentConfig): ExperimentConfig object. See conf/coat.yml for details.
    """
    ...
    evaluator = TestEvaluator(
        ...
        used_metrics={QUANTITATIVE_METRIC, QUALITATIVE_METRIC},
        K=K,
    )
    ...
    for model_name in MODELS:
        for estimator in ESTIMATORS:
            ...
            test_pred_y = model.predict(
                X=evaluator.features[model_name],
            )
